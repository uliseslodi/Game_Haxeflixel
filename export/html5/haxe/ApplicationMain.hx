...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("platformer", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("platformer", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "platformer";
		app.meta["name"] = "platformer";
